...
var DataCell = function (_PureComponent) {
  ...
  function DataCell(props) {
    ...
    _this.renderEditor = function (editing, cell, row, col, dataEditor) {
      if (editing) {
    ...
    _this.renderContent = function (editing, cell, row, col, dataEditor, valueRenderer, valueViewer) {
      return _this.renderComponent(editing, cell) || _this.renderEditor(editing, cell, row, col, dataEditor) || _this.renderViewer(cell, row, col, valueRenderer, valueViewer);
    };
  ...
  _createClass(DataCell, [{
    ...
    value: function render() {
      ...
      var content = contentRenderer(editing, cell, row, col, dataEditor, valueRenderer, valueViewer);
