...
var DataCell = function (_PureComponent) {
  ...
  function DataCell(props) {
    ...
    _this.renderComponent = function (editing, cell) {
    ...
    _this.renderEditor = function (editing, cell, row, col, dataEditor, pressedKey) {
      if (editing) {
        ...
        return _react2.default.createElement(Editor, {
          ...
          clearing: _this.props.clearing,
          value: _this.getEditValue(),
          onChange: _this.handleChange,
          onCommit: _this.handleCommit,
          onRevert: _this.handleRevert,
          onKeyDown: _this.handleKey
        });
      }
    };

    _this.renderViewer = function (cell, row, col, valueRenderer, valueViewer) {
    ...
    _this.renderContent = function (editing, cell, row, col, dataEditor, valueRenderer, valueViewer, pressedKey) {
      return _this.renderComponent(editing, cell) || _this.renderEditor(editing, cell, row, col, dataEditor, pressedKey) || _this.renderViewer(cell, row, col, valueRenderer, valueViewer);
    };

    _this.memoizedRenderContent = (0, _memoizee2.default)(_this.renderContent);
  ...
  _createClass(DataCell, [{
    ...
    value: function render() {
      var _props7 = this.props,
          ...
          pressedKey = _props7.pressedKey;
      var updated = this.state.updated;

      var contentRenderer = editing ? this.renderContent : this.memoizedRenderContent;
      var content = contentRenderer(editing, cell, row, col, dataEditor, valueRenderer, valueViewer, pressedKey);
...
DataCell.propTypes = {
  ...
  pressedKey: _propTypes2.default.string
};
