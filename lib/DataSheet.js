...
var DataSheet = function (_PureComponent) {
  ...
  function DataSheet(props) {
    ...
    _this.renderRow = function (row, i) {
      var _this$props = _this.props,
          SheetRenderer = _this$props.sheetRenderer,
          RowRenderer = _this$props.rowRenderer,
          cellRenderer = _this$props.cellRenderer,
          dataRenderer = _this$props.dataRenderer,
          valueRenderer = _this$props.valueRenderer,
          dataEditor = _this$props.dataEditor,
          valueViewer = _this$props.valueViewer,
          attributesRenderer = _this$props.attributesRenderer,
          className = _this$props.className,
          overflow = _this$props.overflow,
          data = _this$props.data,
          keyFn = _this$props.keyFn,
          pressedKey = _this$props.pressedKey;
      var forceEdit = _this.state.forceEdit;

      if (_this.isRowEditing(i)) {
        _this.memoizedRenderRow.delete(row, i);
      }
      ...
      return _react2.default.createElement(
        ...
        row.map(function (cell, j) {
          var isEditing = _this.isEditing(i, j);
          return _react2.default.createElement(_DataCell2.default, _extends({
            ...
            onRevert: _this.onRevert,
            onNavigate: _this.handleKeyboardCellMovement,
            onKey: _this.handleKey,
            selected: _this.isSelected(i, j),
            pressedKey: pressedKey,
            editing: isEditing,
            clearing: _this.isClearing(i, j),
    ...
    _this.memoizedRenderRow = (0, _memoizee2.default)(_this.renderRow);
  ...
  _createClass(DataSheet, [{
    ...
    key: 'isRowEditing',
    value: function isRowEditing(i) {
      var editingRow = this.state.editing.i;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          data.map(function (row, i) {
            if (_this4.isRowActive(i)) {
              return _this4.renderRow(row, i);
            } else {
              return _this4.memoizedRenderRow(row, i);
            }
          })
        )
      );
